      ...
      <div className="container-custom py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <h3 className="text-xl font-bold mb-4">no manner of -ites</h3>
            <p className="text-gray-400 text-sm mb-6">
              United, not divided. Clothing that brings people together,
              reminding us we're all part of one human family.
            </p>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © {new Date().getFullYear()} No Manner of -ites. All rights reserved.
          </p>
